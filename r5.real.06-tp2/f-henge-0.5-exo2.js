...
//====================================
const viewAngleX = degToRad(40);
const viewAngleY = degToRad(40);
const viewDistance = 500;

let cameraMatrix = math.identity(4);
cameraMatrix = math.multiply(cameraMatrix, translation(0, 0, -viewDistance));
cameraMatrix = math.multiply(cameraMatrix, yRotation(viewAngleY));
cameraMatrix = math.multiply(cameraMatrix, xRotation(viewAngleX));
